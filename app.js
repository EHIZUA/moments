class App {
  ...
  handleFormClick(event) {
    const hasBeenClicked = this.$form.contains(event.target);
  ...
  openToolTip(event) {
    ...
    this.$colorToolTip.style.transform = `translate(
    ...
    this.$notes.innerHTML = this.notes
      .map(
        ...
        <div class="toolbar-container">
          <div class="toolbar">
            <img class="toolbar-color" data-id="${note.id}" src="palette.jpg">
